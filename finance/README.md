---
files: [app.py]
url: https://cdn.cs50.net/2022/fall/psets/9/finance/README.md
window: [terminal]
---
...
Be sure to include a comment at the top of `app.py` to indicate to your Teaching Fellow what your personal touch is!

## Walkthrough

{% video https://www.youtube.com/watch?v=7wPTAwT-6bA %}
...
```
$ check50 cs50/problems/2022/fall/finance
```
...
1. While in your `finance` directory, create a ZIP file of your website by executing:
```
zip -r finance.zip *
```
1. Download your `finance.zip` file by control-clicking or right-clicking on the file in your codespace's file browser and choosing **Download**.
2. Go to CS50's [Gradescope page](https://www.gradescope.com/).
3. Click "Problem Set 9: Finance".
4. Drag and drop your `finance.zip` file to the area that says "Drag & Drop". Be sure it has that **exact** filename! If you upload a file with a different name, the autograder likely will fail when trying to run it, and ensuring you have uploaded files with the correct filename is your responsibility!
5. Click "Upload".
